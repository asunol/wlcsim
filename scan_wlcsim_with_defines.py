...
os.mkdir(os.path.join(skeleton_dir, 'input'))
shutil.copyfile(os.path.join(script_dir, 'input/dssWLCparams'),
                os.path.join(skeleton_dir, 'input/dssWLCparams'))
# copy over ourselves to make inspecting an old scan easier
shutil.copyfile(os.path.join(script_dir, 'scan_wlcsim_with_defines.py'),
                os.path.join(skeleton_dir, 'scan_wlcsim_with_defines.py'))
shutil.copyfile(os.path.join(script_dir, 'fort_depend.py'),
                os.path.join(skeleton_dir, 'fort_depend.py'))
os.chmod(os.path.join(skeleton_dir, 'fort_depend.py'), 0o755)
